                ...
                <table style="background-color: #f2f3f8; max-width:670px; margin:0 auto;" width="100%" border="0"
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <img width="290" src="{{asset('logo.png')}}">
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1 style="color:#1e1e2d; font-weight:500; margin:0; padding-bottom: 20px; font-size:32px;font-family:'Rubik',sans-serif;">Witaj!
                                        </h1>
                                        <p style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">
                                            Ktoś właśnie założył nowe konto w aplikacji Bookigo.co</strong>.</p>
                                        <span
                                            style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span><br />
                                        <!--<p
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong>Bookigo.co</strong> </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="height:80px;">&nbsp;</td>
